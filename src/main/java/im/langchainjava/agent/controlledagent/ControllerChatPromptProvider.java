...
public abstract class ControllerChatPromptProvider extends BasicChatPromptProvider{
    ...
    public List<ChatMessage> getControllerPrompt(String user){
        ...
        String prompt = new StringBuilder()
                            ...
                            .append("Your will be provided a conversation between the ai assistant and the user. The conversation includes function calls.\r\n")
                            .append("You observe the conversation and control the conversation with generate_prompt function.\r\n")
                            .append("Your task is to observe the conversation and produce the next right step to take. You must run the following steps to work it out:\"\"\"\r\n")
                            .append("1. Check through the chat list to see whether the assistant is waiting for user's response and set function input `wait_user_input` accordingly.\r\n")
                            .append("2. Extract user's requirement from the conversation.\r\n")
                            .append("3. Extract the city name from user's requirement.\r\n")
                            .append("4. Check if the requirement is fullfilled.\r\n")
                            .append("5. Think how to fullfill the requirement in a step by step way.\r\n")
                            .append("6. Think what has been done for the requirement.\r\n")
                            .append("7. Think what is the right action to take in the next step.\r\n")
                            .append("8. Decide whether the assistant should continue working on the user's requirement.\r\n")
